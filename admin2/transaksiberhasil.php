...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h3 class="mb-4 text-gray-800 text-center mt-3">Transaksi Berhasil</h3>
            <div id="kanan">
                <?php
                ...
                ?>
                <a href="../function/cetaklaporanberhasil.php"><button type="button" class="btn btn-dark mt-3 mb-3"><i class="bi bi-printer me-2"></i>Cetak Laporan</button></a>
                <table class="table table-sm mt-3">
                    ...
                    if (isset($_GET["keyword"])) {
                        ...
                        $data = mysqli_query($conn, "SELECT * FROM pemesanan WHERE status='Berhasil..'");
                    }
