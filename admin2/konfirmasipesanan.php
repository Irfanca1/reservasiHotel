            ...
            <div id="kanan" class="overflow-auto">
                ...
                <table class="table table-sm mt-3">
                    ...
                    if (isset($_GET["keyword"])) {
                        ...
                        $data = mysqli_query($conn, "SELECT * FROM pemesanan WHERE status='Pending...'");
                    }
                    ...
                    ?>
                        <tbody>
                            <tr style="font-size: 12px;">
                                ...
                                <td>
                                    <a href="../function/proseskonfirmasi.php?id=<?= $id; ?>"><button type="button" class="btn btn-success">Konfirmasi</button></a>
                                    <a href="../function/prosesbatal.php?id=<?= $id; ?>"><button type="button" class="btn btn-danger">Batalkan</button></a>
                                </td>
                            </tr>
                        </tbody>
                    <?php } ?>
